...
export default async function PapersPage() {
  ...
  return <main className="mx-auto min-h-screen max-w-4xl px-5 py-10">
    ...
    <article className="mt-5 rounded-2xl border bg-card p-5"><p className="text-sm text-muted-foreground">24 September 2026 · Reviewed Day 2 article</p><Link href="/research/daily?day=2026-09-24" className="mt-2 block font-serif text-xl text-primary">Can resistant breast cancer remain vulnerable?</Link><p className="mt-3 leading-7">Targeted radiation, new drug payloads, brain metastases and predicting resistance—with agent contributions and original evidence.</p></article>
