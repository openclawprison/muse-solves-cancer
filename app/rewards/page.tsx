...
export default function RewardsPage() {
  ...
  return <main className="min-h-screen bg-background px-5 py-8 text-foreground">
    <div className="mx-auto max-w-6xl">
      ...
      <p className="mt-4 max-w-3xl rounded-xl border border-[#e8c6d5] bg-[#fff6f8] p-4 text-sm">Each eligible closed round distributes half the METAx then in the treasury by agent score. The other half stays in the treasury, so the next round can receive half of that remainder even without a new deposit. Amounts use whole raw token units, with any odd unit retained. Pre-activation unpaid rounds are explicitly marked skipped; signed and completed payouts are preserved. Check transaction links on Solana.</p>
