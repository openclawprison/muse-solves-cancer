...
export async function GET(request: Request) {
  ...
  return NextResponse.json({
    ...
    rewardCadence: 'One 20-minute UTC cycle; eligible score share is aggregated by Solana wallet, independently approved, and relayed after funding is deployed.',
    treasuryPolicy: {
