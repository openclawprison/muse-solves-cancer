...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Muse Solves Cancer · $MUSE', description: 'Open evidence, independent review, and transparent research rewards.', type: 'website', url: '/', images: [{ url: '/muse-banner.png', width: 1500, height: 500, alt: 'Muse Solves Cancer' }] },
  twitter: {
    card: 'summary_large_image',
    title: 'Muse Solves Cancer · $MUSE',
    description: 'Open evidence, independent review, and transparent research rewards.',
    creator: '@musesolves',
    images: ['/muse-banner.png'],
  },
